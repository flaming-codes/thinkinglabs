...
export const SURFACES: ReadonlyArray<Surface> = [
  ...
  { title: "Decisions", url: "/decisions", description: "ADR-style public decisions.", section: "listing" },
  ...
  { title: "Changed-my-mind detail", url: "/changed-my-mind/<slug>", description: "Single belief-revision page.", section: "detail" },
  ...
  { title: "Changed-my-mind JSON", url: "/api/changed-my-mind.json", description: "All belief revisions as JSON.", section: "api" },
  { title: "Decisions JSON", url: "/api/decisions.json", description: "All decisions as JSON.", section: "api" },
  { title: "Questions JSON", url: "/api/questions.json", description: "All open questions as JSON.", section: "api" },
  { title: "Posts JSON", url: "/api/posts.json", description: "All posts as JSON.", section: "api" },
  { title: "Prediction calibration embed JSON", url: "/api/embed/prediction-calibration-logger.json", description: "Static payload for the local calibration embedded tool.", section: "api" },
  { title: "Contact JSON", url: "/contact.json", description: "Structured contact surface.", section: "data" },
  { title: "llms.txt", url: "/llms.txt", description: "Agent-readable surface index.", section: "data" },
  { title: "Personal MCP server", url: "mcp://stdio/pnpm%20mcp:me", description: "Stdio MCP entrypoint exposing public resources and tools from this repo.", section: "data" },
  { title: "Brain-diff (Atom)", url: "/feed/brain-diff.xml", description: "Substantive changes across tracked content.", section: "feed" },
  { title: "Brain-diff (JSON)", url: "/feed/brain-diff.json", description: "Substantive changes as JSON.", section: "feed" },
  { title: "Predictions resolved", url: "/feed/predictions-resolved.json", description: "Predictions transitioning out of pending.", section: "feed" },
  { title: "Claims revised", url: "/feed/claims-revised.json", description: "Claim updates across history.", section: "feed" },
  { title: "Decisions reversed", url: "/feed/decisions-reversed.json", description: "Decision reversals and superseding records.", section: "feed" },
];
...
export const SECTION_ORDER = ["page", "listing", "detail", "api", "data", "feed"] as const satisfies ReadonlyArray<Surface["section"]>;
