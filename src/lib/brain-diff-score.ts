...
/** System prompt is reused across calls; prompt-cached so the cost of repeated invocations collapses. */
...
/** Tool definition; Anthropic tool-use guarantees the response shape so we don't parse free-text. */
const TOOL = {
